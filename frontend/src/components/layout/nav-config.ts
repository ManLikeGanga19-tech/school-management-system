...
export const saasNav: AppNavItem[] = [
  ...
  { href: "/saas/backups", label: "Backups", icon: "DatabaseBackup" },
  { href: "/saas/changelog", label: "Changelog", icon: "Megaphone" },
...
export const directorNav: AppNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: directorFinanceHref("payments"), label: "Payments", icon: "HandCoins", permission: "finance.payments.view" },
      { href: directorFinanceHref("receipts"), label: "Receipts", icon: "Receipt", permission: "finance.payments.view" },
      { href: directorFinanceHref("collections"), label: "Daily Collections", icon: "CalendarDays", permission: "finance.payments.view" },
...
export const secretaryNav: AppNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: secretaryFinanceHref("payments"), label: "Payments", icon: "HandCoins", permission: "finance.payments.view" },
      { href: secretaryFinanceHref("receipts"), label: "Receipts", icon: "Receipt", permission: "finance.payments.view" },
      { href: secretaryFinanceHref("collections"), label: "Daily Collections", icon: "CalendarDays", permission: "finance.payments.view" },
...
export const parentNav: AppNavItem[] = [
  ...
  { href: "/tenant/parent/progress",  label: "My Child's Progress", icon: "TrendingUp" },
];
